...
def create_spark_connection():
    ...
    try:
        ...
        logging.error(f"Cloudn't create the spark session due to exception {e}")
...
def create_cassandra_connection():
    ...
    try:
        ...
        logging.error(f"Cloudn't create cassandra connection due to {e}")
        return None
...
if __name__ == "__main__":
    ...
    if spark_conn is not None:
        ...
        selection_df = create_df_from_Kafka(df)
